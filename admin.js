...
const adminViews = new Set(["customers", "sales", "logistics", "production", "production-materials", "production-stock", "production-recipes", "production-suppliers", "commissions", "distributors", "products", "prices", "orders", "accounts", "settings", "emails", "security", "analytics", "operation"]);
const statusLabels = {
...
const ADMIN_VIEW_ICONS = {
  customers: "users", sales: "user-round", logistics: "truck", production: "package", "production-materials": "package", "production-stock": "package", "production-recipes": "clipboard-list", "production-suppliers": "building", commissions: "coins", distributors: "building",
